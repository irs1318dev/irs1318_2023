...
public class ArmMechanismTests
{
    ...
    {
        ArmAngleSetpoint setpoint = ArmMechanism.calculateIKAngles(0.0, Math.abs(HardwareConstants.LOWER_ARM_LENGTH - HardwareConstants.UPPER_ARM_LENGTH));
    ...
    {
        ArmAngleSetpoint setpoint = ArmMechanism.calculateIKAngles(0.0, HardwareConstants.UPPER_ARM_LENGTH + HardwareConstants.LOWER_ARM_LENGTH);
        assertEquals(90.0, setpoint.lowerAngle, 0.01, "lower angle");
    ...
    {
        ArmAngleSetpoint setpoint = ArmMechanism.calculateIKAngles(HardwareConstants.UPPER_ARM_LENGTH + HardwareConstants.LOWER_ARM_LENGTH, 0.0);
    ...
    {
        ArmAngleSetpoint setpoint = ArmMechanism.calculateIKAngles(HardwareConstants.UPPER_ARM_LENGTH, HardwareConstants.LOWER_ARM_LENGTH);
        assertEquals(90.0, setpoint.lowerAngle, 0.01, "lower angle");
    ...
    {
        ArmAngleSetpoint setpoint = ArmMechanism.calculateIKAngles(HardwareConstants.LOWER_ARM_LENGTH, -HardwareConstants.UPPER_ARM_LENGTH);
        assertEquals(0.0, setpoint.lowerAngle, 0.01, "lower angle");
        assertEquals(90.0, setpoint.upperAngle, 0.01, "upper angle");
    }
    ...
    {
        ArmAngleSetpoint setpoint = ArmMechanism.calculateIKAngles(HardwareConstants.LOWER_ARM_LENGTH * Helpers.sind(45.0) + HardwareConstants.UPPER_ARM_LENGTH, HardwareConstants.LOWER_ARM_LENGTH * Helpers.cosd(45.0));
    ...
    {
        ArmAngleSetpoint setpoint = ArmMechanism.calculateIKAngles(HardwareConstants.LOWER_ARM_LENGTH + HardwareConstants.UPPER_ARM_LENGTH, HardwareConstants.LOWER_ARM_LENGTH + HardwareConstants.UPPER_ARM_LENGTH);
        assertEquals(null, setpoint, "setpoint");
    }
}
