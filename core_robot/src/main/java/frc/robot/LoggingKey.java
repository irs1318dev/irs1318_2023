...
public enum LoggingKey
{
    ...
    OffboardVisionRRTargetDistance("vision.rr_distance", true),
    OffboardVisionRRTargetHorizontalAngle("vision.rr_horizontalAngle", true),
    OffboardVisionAprilTagXOffset("vision.atXOffset", true),
    OffboardVisionAprilTagYOffset("vision.atYOffset", true),
    OffboardVisionAprilTagZOffset("vision.atZOffset", true),
    OffboardVisionAprilTagYaw("vision.atYaw", true),
    OffboardVisionAprilTagPitch("vision.atPitch", true),
    OffboardVisionAprilTagRoll("vision.atRoll", true),
    OffboardVisionProcessingMode("vision.processingMode", true),
    OffboardVisionEnableStream("vision.enableStream", true),
    OffboardVisionMissedHeartbeats("vision.missedHeartbeats", true),
