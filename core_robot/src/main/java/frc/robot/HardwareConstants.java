...
public class HardwareConstants
{
    ...
    public static final double DRIVETRAIN_DRIVE_WHEEL_DIAMETER = 3.875; // SDS Mk4i code claims their 4-inch wheels are actually 3.95 inches now (in inches) We think its 3.95
