...
public class ButtonMap implements IButtonMap
{
    ...
    public static MacroOperationDescription[] MacroSchema = new MacroOperationDescription[]
    {
        ...
        //                 TuningConstants.ARM_LOWER_POSITION_APPROACH,
        //                 TuningConstants.ARM_UPPER_POSITION_APPROACH),
        //             new VisionAlignmentTranslateTask(GridScoringPosition.MiddleCube),
        //             new DriveTrainFieldOrientationModeTask(true)),
        //         new RumbleTask()),
        //     new IOperation[]
        //     {
        ...
        //             new VisionAlignmentTranslateTask(GridScoringPosition.LeftCone),
        //             new DriveTrainFieldOrientationModeTask(true)),
        //         new RumbleTask()),
        //     new IOperation[]
        //     {
        ...
        //             new VisionMoveAndTurnTask(TurnType.None, MoveType.AprilTagStrafe, MoveSpeed.Normal, false, true, 0.0),
        //             new DriveTrainFieldOrientationModeTask(true),
        //             new VisionAlignmentTranslateTask(GridScoringPosition.RightCone),
        //             new DriveTrainFieldOrientationModeTask(true)),
        //         new RumbleTask()),
        //     new IOperation[]
        //     {
