...
public class ChargeStationTaskV3 extends ControlTaskBase
{
     ...
     */
    public ChargeStationTaskV3(boolean reverse)
    {
     ...
     */
    public ChargeStationTaskV3(boolean reverse, Orientation orientation)
    {
    ...
    public void update()
    {
        ...
        else if (this.currentState == State.Climbing)
        {
            ...
            {
                if (currTime - this.climbingExceededTransitionTime >= TuningConstants.CHARGE_STATION_CLIMBING_TRANSITION_WAIT_DURATION_V3)
                {
