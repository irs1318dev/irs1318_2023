...
public class PathPlannerTrajectoryGenerator
{
    ...
    public static void generateTrajectories(boolean isRed, TrajectoryManager trajectoryManager, IPathPlanner pathPlanner)
    {
        ...
        Point2d P2 = new Point2d(getXPosition(isRed, 299.199673 - 0) , 78.285726 - 0); //-30 degrees
        Point2d P3 = new Point2d(getXPosition(isRed, 250.5 + halfFramePreremetere), 324.0 + halfFramePreremetere);
        Point2d P4 = new Point2d(getXPosition(isRed, 288.432368 - halfFramePreremetere), 116.473567 + halfFramePreremetere);
        Point2d P5 = new Point2d(getXPosition(isRed, 212.6), 46.888409);
        Point2d P5M = new Point2d(getXPosition(isRed, 212.6 + 10), 46.888409);
        Point2d P6 = new Point2d(getXPosition(isRed, 212.6), 103.888409);
        Point2d P6M = new Point2d(getXPosition(isRed, 212.6 + 10), 103.888409);
        Point2d P7 = new Point2d(getXPosition(isRed, 212.6), 160.888409);
        ...
        addTrajectory(
            ...
            pathPlanner.buildTrajectory(
                ...
                new PathPlannerWaypoint(P5, getOrientationOrHeading(isRed, 0), getOrientationOrHeading(isRed, 112.5))),
                "P3toP5");
    }
