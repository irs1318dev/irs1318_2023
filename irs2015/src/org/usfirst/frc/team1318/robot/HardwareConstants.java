...
{
    public static final double DRIVETRAIN_LEFT_ENCODER_PULSES_PER_REVOLUTION = 360.0; // TODO: validate this number
    public static final double DRIVETRAIN_LEFT_WHEEL_DIAMETER = 4.0 * 2.54; // (in centimeters)
    ...
    public static final double DRIVETRAIN_RIGHT_ENCODER_PULSES_PER_REVOLUTION = 360.0; // TODO: validate this number
    public static final double DRIVETRAIN_RIGHT_WHEEL_DIAMETER = 4.0 * 2.54; // (in centimeters)
    public static final double DRIVETRAIN_RIGHT_PULSE_DISTANCE = Math.PI
        * HardwareConstants.DRIVETRAIN_LEFT_WHEEL_DIAMETER / HardwareConstants.DRIVETRAIN_RIGHT_ENCODER_PULSES_PER_REVOLUTION;
