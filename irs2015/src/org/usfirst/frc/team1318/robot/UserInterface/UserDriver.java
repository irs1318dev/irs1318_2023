...
public class UserDriver implements IDriver
{
    ...
    public UserDriver()
    {
        this.joystickDriver = new Joystick(JoystickButtonConstants.JOYSTICK_PORT);
    ...
    public void update()
    {
        ...
        this.armExtenderExtendOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ARM_EXTENDER_EXTEND_BUTTON));
        this.armExtenderRetractOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ARM_EXTENDER_RETRACT_BUTTON));
        this.armTiltExtendOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ARM_TILT_EXTEND_BUTTON));
        this.armTiltRetractOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ARM_TILT_RETRACT_BUTTON));
        this.armTromboneExtendOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ARM_TROMBONE_EXTEND_BUTTON));
        this.armTromboneRetractOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ARM_TROMBONE_RETRACT_BUTTON));
        ...
        this.intakeRightExtendOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.INTAKE_RIGHT_EXTEND_OVERRIDE));
        this.intakeRightRetractOverride
            .updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.INTAKE_RIGHT_RETRACT_OVERRIDE));
        this.intakeLeftExtendOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.INTAKE_LEFT_EXTEND_OVERRIDE));
        this.intakeLeftRetractOverride.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.INTAKE_LEFT_RETRACT_OVERRIDE));
        ...
        this.elevatorPIDOn.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ELEVATOR_PID_ON));
        this.elevatorPIDOff.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ELEVATOR_PID_OFF));
        this.elevatorStop.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ELEVATOR_STOP_BUTTON));
        ...
        this.elevatorMoveToBottom.updateState(this.joystickDriver.getRawButton(JoystickButtonConstants.ELEVATOR_MOVE_TO_BOTTOM));
    }
