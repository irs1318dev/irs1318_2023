...
public class ElectronicsConstants
{
    ...
    public static final int DRIVETRAIN_RIGHT_ENCODER_CHANNEL_A = 8;
    public static final int DRIVETRAIN_RIGHT_ENCODER_CHANNEL_B = 9;

    public static final int DRIVETRAIN_LEFT_ENCODER_CHANNEL_A = 6;
